...
namespace Tests
{
    ...
    public class PermisisionAdapter_Tests
    {
        ...
        public void CreatePermission_ShouldInsertPermission()
        {
            ...
            SqlConnection sqlConnection = new SqlConnection("Data Source=DESKTOP-2OA983C;Initial Catalog=DrinkDB_Test;Integrated Security=True;Trust Server Certificate=True");
