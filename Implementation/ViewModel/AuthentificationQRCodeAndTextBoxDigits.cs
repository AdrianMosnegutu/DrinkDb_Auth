...
{
    public class AuthentificationQRCodeAndTextBoxDigits : INotifyPropertyChanged
    {
        ...
        public AuthentificationQRCodeAndTextBoxDigits(string keyCode = AuthentificationQRCodeAndTextBoxDigits.QRCodeDefaultKeyCode)
        {
